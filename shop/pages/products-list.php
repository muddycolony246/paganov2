        ...
        <?php foreach ($products as $product) : ?>
            <div class="product-card card mb-3 col-md-3 col-6">
                ...
                <?php if (!empty($product->image_path)) : ?>
                    <img src="<?php echo ROOT_URL . $product->image_path; ?>" class="card-img-top" alt="Immagine prodotto">
                <?php else: ?>
                    <img src="placeholder.jpg" class="card-img-top" alt="Placeholder immagine">
                <?php endif; ?>
